...
export const ui = {
  ...
  btnIndebtPromo: el<HTMLButtonElement>('btn-indebt-promo'),
  ...
  customerPoints: el('customer-points-display'),
  ...
  mathQuestionText: el('math-question-text'),
  mathFeedback: el('math-feedback'),
